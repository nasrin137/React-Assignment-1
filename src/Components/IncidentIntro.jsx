...
function IncidentIntro() {
  ...
  <button onClick={handleBack} className='bg-white  btn text-ash font-bold text-sm border border-[#D4D4D8] px-9 py-2 w-[139px] h-[42px] rounded-md mt-4 md:mt-0 mb-2 md:mb-0'>
    Back</button>
