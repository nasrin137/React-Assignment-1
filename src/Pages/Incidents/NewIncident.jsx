   ...
   <button onClick={handleClick} className='bg-primary btn font-bold text-sm  text-white w-[139px] h-[42px] rounded-md hover:bg-white transition-all duration-300 hover:text-primary'>Next Step</button>
      ...
      <Container>
        <div className='w-[900px] mx-auto mt-10'>
            <h1 className='text-2xl font-bold text-dark'>Which of these best describes the incident?</h1>
            <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-1 mt-8'>
                {
