...
function Incidents() {
  ...
  return (
    ...
    <div className="flex-col md:flex md:flex-row md:justify-between md:items-center py-1  md:py-3  md:px-20 bg-gray ">
            ...
            <CiSearch className="absolute top-4 left-12 md:absolute md:top-4 md:left-12" /><input  type="text" className="w-[190px] h-[42px] rounded-md  border-[1px] border-secondary bg-[#FAFAFA] py-3 px-[10px] text-ash pl-8 text-sm" placeholder="Search incident"/>
